            ...
            while ($row = mysqli_fetch_assoc($result)) {
              ...
              echo "<td>
                      <div class='btn-group' role='group'>
                        <a href='update_order.php?id=".$row['order_id']."&status=delivered' class='btn btn-success btn-sm'>Mark Delivered</a>
                        <a href='update_order.php?id=".$row['order_id']."&status=canceled' class='btn btn-danger btn-sm'>Cancel Order</a>
                      </div>
                    </td>";
              echo "</tr>";
            }
